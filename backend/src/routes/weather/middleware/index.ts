...
const latitudeMiddleware = new RegexParameterValidator(
  "latitude",
  GPS_COORD_REGEX,
  EParamType.query,
  true
);
const longitudeMiddleware = new RegexParameterValidator(
  "longitude",
  GPS_COORD_REGEX,
  EParamType.query,
  true
...
const weatherIconMiddleware = new RegexParameterValidator(
  "weatherCode",
  WEATHER_ICON_REGEX,
  EParamType.request,
  true
...
export const currentMw = [
  latitudeMiddleware.validate,
  longitudeMiddleware.validate,
];
export const hourlyMw = [
  hourlyQryMiddleware.validate,
  latitudeMiddleware.validate,
  longitudeMiddleware.validate,
];
export const daysMw = [
  daysQryMiddleware.validate,
  latitudeMiddleware.validate,
  longitudeMiddleware.validate,
];
